<%-- 
    Document   : footer
    Created on : Apr 4, 2019, 9:23:17 AM
    Author     : DELL
--%>
...
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
		...
		===============================================-->
		<!-- jquery js -->
		<script src="/shopthethao/public/js/vendor/jquery-1.11.3.min.js"></script>
		
		<!-- fancybox js -->
        <script src="/shopthethao/public/js/jquery.fancybox.js"></script>
		
		<!-- bxslider js -->
        <script src="/shopthethao/public/js/jquery.bxslider.min.js"></script>
		
		<!-- meanmenu js -->
        <script src="/shopthethao/public/js/jquery.meanmenu.js"></script>
		
		<!-- owl carousel js -->
        <script src="/shopthethao/public/js/owl.carousel.min.js"></script>
		
		<!-- nivo slider js -->
        <script src="/shopthethao/public/js/jquery.nivo.slider.js"></script>
		
		<!-- jqueryui js -->
        <script src="/shopthethao/public/js/jqueryui.js"></script>
		
		<!-- bootstrap js -->
        <script src="/shopthethao/public/js/bootstrap.min.js"></script>
		
		<!-- wow js -->
        <script src="/shopthethao/public/js/wow.js"></script>		
		<script>
			new WOW().init();
		</script>
...
<!--        <script src="https://maps.googleapis.com/maps/api/js"></script>	
		...
		<!-- main js -->
        <script src="/shopthethao/public/js/main.js"></script>
    </body>
